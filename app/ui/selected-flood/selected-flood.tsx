...
export default function SelectedFlood() {
    ...
    if(selectedWarning) {
        ...
        return(
            <aside className="fixed top-0 left-0 z-40 lg:max-w-1/3 m:max-w-1/2 sm:max-w-1/2 h-screen mt-35 transition-all"
                   aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-blue-900">
                    ...
                    <ul className="lg:space-y-10 m:space-y-5 sm:space-y-3 p-5">
                        <li>
                            <span className="flex-wrap items-center sm:justify-start rounded-b-sm font-bold underline
                            lg:text-2xl m:text-lg sm:text-lg @xs:text-m">
                        ...
                        <li>
                            {selectedWarning.severityLevel === 1 &&
                                <Fragment>
                                    <ul className="lg:space-y-3 m:space-y-2 sm:space-y-1">
                                        <li>
                                            <Image
                                            ...
                                            lg:text-2xl m:text-lg sm:text-m text-red-800">
                                                {selectedWarning.severity}
                                            </span>
                                        </li>
                                        <li>
                                            <span className="flex-nowrap items-center sm:justify-start
                                ...
                                <Fragment>
                                    <ul className="space-y-3">
                                        <li>
                                            ...
                                            />
                                            <span className="flex-nowrap items-center sm:justify-start rounded-b-sm font-bold text-2xl
                                            lg:text-2xl m:text-lg sm:text-m text-red-600">
                                                {selectedWarning.severity}
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <Fragment>
                                    <ul className="space-y-3">
                                        <li>
                                            ...
                                            />
                                            <span className="flex-nowrap items-center sm:justify-start rounded-b-sm font-bold
                                            lg:text-2xl m:text-lg sm:text-m @xs:text-sm text-yellow-500">
                                                {selectedWarning.severity}
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <Fragment>
                                    <ul className="space-y-3">
                                        <li>
                                            ...
                                            />
                                            <span className="flex-nowrap items-center sm:justify-start rounded-b-sm font-bold
                                            lg:text-2xl m:text-lg sm:text-m text-blue-400">
                                                {selectedWarning.severity}
                                            </span>
                                        </li>
                                        <li>
